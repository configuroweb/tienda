...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("¿Está seguro de eliminar este cliente de forma permanente?","delete_client",[$(this).attr('data-id')])
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Actualizar Información de Cliente","clients/manage_client.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
