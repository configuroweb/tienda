...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Nosotros</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Política de Privacidad</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Banner Página Web</label>
				<div class="custom-file">
			...
			<div class="form-group">
				<label for="" class="control-label">Imágenes del Banner</label>
				<div class="custom-file">
				...
				<small><i>Escoger Imágenes</i></small>
			</div>
			<?php 
